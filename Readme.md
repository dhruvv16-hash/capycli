...
WARNING: Most operating systems allow easy access to command line
arguments of running processes and in some cases also environment
variables. Therefore, it is recommended to use the config file,
especially for the long-lived Keycloak secrets!
